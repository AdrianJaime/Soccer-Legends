...
//    public Text timeLeft, timeLeftSH, progress, progressSH, playerName, playerNameSH, coin, ball, rank, rankSH;
...
//            if (stamina == 10) timeLeftSH.text = timeLeft.text = "--:--";
//            else timeLeftSH.text = timeLeft.text = timeleftString;
//            progressSH.text = progress.text = stamina.ToString() + "/" + maxSta.ToString();
//            staSlider.value = stamina;

//            if (playerName.text == "") playerNameSH.text = playerName.text = nameStr;
//            if (coin.text == "") coin.text = coinStr;
//            if (ball.text == "") ball.text = ballStr;
//            if (rank.text == "") rankSH.text = rank.text = "RANK: " + rankStr;
